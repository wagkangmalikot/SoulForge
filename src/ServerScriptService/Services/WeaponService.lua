...
function WeaponService.EquipWeapons(character: Model, weaponSetId: string?, shieldSetId: string?)
	...
	-- 2. Equip Shield (Tank only; Mages/Healers/other staff wielders and Warriors do not carry shields)
	if not STAFF_STYLE_WEAPONS[targetWeapon] and classId ~= "Warrior" then
